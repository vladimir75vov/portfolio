    ...
    <main className="min-h-screen bg-[var(--bg-primary)] pt-32 pb-20">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-4xl mx-auto mb-20 relative">
          ...
          {christmasMode && (
            <>
              <Image src="/portfolio/images/Christmas tree.png" alt="Christmas tree" width={120} height={120} className="absolute -top-10 left-0 opacity-30 pointer-events-none select-none brightness-150 drop-shadow-[0_0_10px_rgba(255,255,255,0.3)] transition-transform duration-700 ease-out" style={{ transform: `translate(${tilt.x * 0.5}px, ${tilt.y * 0.5}px)` }} unoptimized />
              <Image src="/portfolio/images/Christmas tree.png" alt="Christmas tree" width={100} height={100} className="absolute -top-5 right-5 opacity-25 pointer-events-none select-none brightness-150 drop-shadow-[0_0_10px_rgba(255,255,255,0.3)] transition-transform duration-700 ease-out" style={{ transform: `translate(${tilt.x * 0.7}px, ${tilt.y * 0.7}px)` }} unoptimized />
              <Image src="/portfolio/images/Christmas tree.png" alt="Christmas tree" width={80} height={80} className="absolute top-20 left-1/4 opacity-20 pointer-events-none select-none brightness-150 drop-shadow-[0_0_10px_rgba(255,255,255,0.3)] transition-transform duration-700 ease-out" style={{ transform: `translate(${tilt.x * 0.3}px, ${tilt.y * 0.3}px)` }} unoptimized />
            </>
          )}
          {autumnMode && (
            <>
              <span className="absolute -top-10 left-0 text-8xl opacity-30 pointer-events-none select-none transition-transform duration-700 ease-out" style={{ transform: `translate(${tilt.x * 0.5}px, ${tilt.y * 0.5}px)` }}>🍂</span>
              <span className="absolute -top-5 right-5 text-7xl opacity-25 pointer-events-none select-none transition-transform duration-700 ease-out" style={{ transform: `translate(${tilt.x * 0.7}px, ${tilt.y * 0.7}px)` }}>🍁</span>
              <span className="absolute top-20 left-1/4 text-6xl opacity-20 pointer-events-none select-none transition-transform duration-700 ease-out" style={{ transform: `translate(${tilt.x * 0.3}px, ${tilt.y * 0.3}px)` }}>🍂</span>
            </>
          )}
