    ...
    <nav className="fixed top-0 left-0 right-0 z-50 bg-gradient-to-b from-background/10 to-background/6 backdrop-blur-sm border-b border-gray-700/10">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-4 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-6 lg:gap-8">
          <Link href="/about" className="text-white drop-shadow-[0_2px_4px_rgba(0,0,0,0.8)] hover:text-blue-400 transition-colors duration-200 font-medium">
            {useContext(LanguageContext).t("nav.about")}
          </Link>
          <Link href="/projects" className="text-white drop-shadow-[0_2px_4px_rgba(0,0,0,0.8)] hover:text-blue-400 transition-colors duration-200 font-medium">
            {useContext(LanguageContext).t("nav.projects")}
          </Link>
          <Link href="/skills" className="text-white drop-shadow-[0_2px_4px_rgba(0,0,0,0.8)] hover:text-blue-400 transition-colors duration-200 font-medium">
            {useContext(LanguageContext).t("nav.skills")}
          </Link>
          <Link href="/contact" className="text-white drop-shadow-[0_2px_4px_rgba(0,0,0,0.8)] hover:text-blue-400 transition-colors duration-200 font-medium">
      ...
      {isOpen && (
        <div className="md:hidden bg-[var(--bg-primary)]/95 border-t border-[var(--border-color)]">
          <div className="container mx-auto px-4 sm:px-6 py-6 flex flex-col gap-4">
            <Link href="/about" className="text-[var(--text-secondary)] hover:text-blue-400 transition-colors py-2 font-medium">
              {useContext(LanguageContext).t("nav.about")}
            </Link>
            <Link href="/projects" className="text-[var(--text-secondary)] hover:text-blue-400 transition-colors py-2 font-medium">
              {useContext(LanguageContext).t("nav.projects")}
            </Link>
            <Link href="/skills" className="text-[var(--text-secondary)] hover:text-blue-400 transition-colors py-2 font-medium">
              {useContext(LanguageContext).t("nav.skills")}
            </Link>
            <Link href="/contact" className="text-[var(--text-secondary)] hover:text-blue-400 transition-colors py-2 font-medium">
              {useContext(LanguageContext).t("nav.contact")}
            </Link>
